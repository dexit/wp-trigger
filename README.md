...
Place wp-trigger-hook.php in your plugin directory and activate it in your wordpress->plugins dashboard.
...
Because I use the splat operator you need PHP 5.6 or higher.

**NOTE**: this file also switches error reporting on.
